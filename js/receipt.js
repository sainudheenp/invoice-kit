...
function _buildRecHTML(savedRec, comp) {
  ...
  return '<div style="font-family:"Traditional Arabic",Arial,Helvetica,sans-serif;font-size:13px;color:#333;position:relative;background:#fff;line-height:1.8;min-height:100vh;padding:7mm 8mm 0;-webkit-font-smoothing:antialiased;font-kerning:normal">' +
    ...
    '<span style="color:#999">Date / <span dir="rtl" unicode-bidi="embed">التاريخ</span></span> <strong style="color:#333">' + dts + '</strong>' +
    '</div></div>' +
    ...
    '<tr><td style="width:30%;padding:2.5mm 2mm;border-bottom:1px solid #eee;font-size:11px;font-weight:700;color:' + ac + ';text-transform:uppercase;letter-spacing:.1px">Received from</td>' +
    '<td style="width:40%;padding:2.5mm 2mm;border-bottom:1px solid #eee;font-size:13px;color:#333;font-weight:600">' + esc(rf||'—') + '</td>' +
    '<td style="width:30%;padding:2.5mm 2mm;border-bottom:1px solid #eee;text-align:right;direction:rtl;unicode-bidi:embed;font-size:11px;color:#999">استلمت من</td></tr>' +
    '<tr><td style="padding:2.5mm 2mm;border-bottom:1px solid #eee;font-size:11px;font-weight:700;color:' + ac + ';text-transform:uppercase;letter-spacing:.1px">Amount</td>' +
    '<td style="padding:2.5mm 2mm;border-bottom:1px solid #eee;font-size:13px;color:#333;font-weight:700">' + esc(ww) + '</td>' +
    '<td style="padding:2.5mm 2mm;border-bottom:1px solid #eee;text-align:right;direction:rtl;unicode-bidi:embed;font-size:11px;color:#999">بمبلغ قدره</td></tr>' +
    '<tr><td style="padding:2.5mm 2mm;border-bottom:1px solid #eee;font-size:11px;font-weight:700;color:' + ac + ';text-transform:uppercase;letter-spacing:.1px">Payment</td>' +
    '<td style="padding:2.5mm 2mm;border-bottom:1px solid #eee;font-size:13px;color:#333">' + esc(pm) + chqHtml + '</td>' +
    '<td style="padding:2.5mm 2mm;border-bottom:1px solid #eee;text-align:right;direction:rtl;unicode-bidi:embed;font-size:11px;color:#999">نقد / شيك</td></tr>' +
    ((bk||td) ? '<tr><td style="padding:2.5mm 2mm;border-bottom:1px solid #eee;font-size:11px;font-weight:700;color:' + ac + ';text-transform:uppercase;letter-spacing:.1px">Bank / Date</td>' +
    '<td style="padding:2.5mm 2mm;border-bottom:1px solid #eee;font-size:13px;color:#333">' + esc(bk) + (bk&&td?' / ':'') + esc(td) + '</td>' +
    '<td style="padding:2.5mm 2mm;border-bottom:1px solid #eee;text-align:right;direction:rtl;unicode-bidi:embed;font-size:11px;color:#999">البنك / تاريخه</td></tr>' : '') +
    '<tr><td style="padding:2.5mm 2mm;border-bottom:1px solid #eee;font-size:11px;font-weight:700;color:' + ac + ';text-transform:uppercase;letter-spacing:.1px">Being / <span dir="rtl" unicode-bidi="embed">بيان</span></td>' +
    '<td style="padding:2.5mm 2mm;border-bottom:1px solid #eee;font-size:13px;color:#333">' + esc(bg||'—') + '</td>' +
    '<td style="padding:2.5mm 2mm;border-bottom:1px solid #eee;text-align:right;direction:rtl;unicode-bidi:embed;font-size:11px;color:#999">بيان</td></tr>' +
    '</table>' +
    ...
    '<div style="font-size:9px;color:#999;margin-top:1px">Receiver / <span dir="rtl" unicode-bidi="embed">المستلم</span></div>' +
    (c.signature ? '<div style="margin-top:4px"><img src="' + c.signature.replace(/"/g,'&quot;') + '" style="max-width:100px;max-height:36px;object-fit:contain"><div style="font-size:10px;color:#999;margin-top:1px">Authorized Signature / <span dir="rtl" unicode-bidi="embed">التوقيع</span></div></div>' : '') +
    '</div></div>' : '') +
