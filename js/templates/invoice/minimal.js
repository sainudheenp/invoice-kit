...
window._INV_TEMPLATES.minimal = function (d) {
  ...
  d.items.forEach(function (it, i) {
    ir += '<div style="display:flex;padding:3px 0;font-size:13px">' +
  ...
  return '<div style="font-family:Arial,Helvetica,sans-serif;font-size:14px;color:#333;position:relative;background:#fff;line-height:1.7;min-height:100vh;padding:16mm 18mm;max-width:700px;margin:0 auto;font-kerning:normal">' +
    ...
    '<div style="font-size:22px;font-weight:700;color:#000;letter-spacing:-.2px">' + esc(c.name) + '</div>' +
    ...
    '<div style="font-size:12px;text-transform:uppercase;letter-spacing:2px;color:#999">INVOICE</div>' +
    '<div style="font-size:14px;color:#555;margin-top:2px">' + esc(d.no) + ' \u00b7 ' + d.dt + (d.dueDt ? ' \u00b7 Due ' + d.dueDt : '') + '</div>' +
    '</div>' +
    '<div style="margin-bottom:5mm">' +
    '<div style="font-size:12px;color:#999;margin-bottom:2px;text-transform:uppercase;letter-spacing:.5px">Bill To</div>' +
    ...
    '<div style="display:flex;padding:4px 0;font-size:12px;font-weight:600;color:#888;border-bottom:1px solid #ddd;text-transform:uppercase;letter-spacing:.3px">' +
    ...
    '</div></div>' +
    (d.notes || c.invTerms ? '<div style="margin-bottom:4mm;font-size:12px;color:#888;border-top:1px solid #eee;padding-top:3mm">' +
    (d.notes ? '<div>Note: ' + esc(d.notes) + '</div>' : '') +
    (c.invTerms ? '<div>Terms: ' + esc(c.invTerms) + '</div>' : '') +
    '</div>' : '') +
    '<div style="margin-top:6mm;padding-top:3mm;border-top:1px solid #eee;font-size:11px;color:#aaa;text-align:center">' +
