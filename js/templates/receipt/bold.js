...
window._REC_TEMPLATES.bold = function (d) {
  ...
  return '<div style="font-family:Arial,Helvetica,sans-serif;font-size:14px;color:#333;position:relative;background:#fff;line-height:1.7;min-height:100vh;padding:0;font-kerning:normal">' +
    ...
    '<div style="font-size:11px;color:' + pc + ';text-transform:uppercase;letter-spacing:2px;font-weight:700">RECEIPT</div>' +
    '<div style="font-size:18px;font-weight:800;color:#fff;margin-top:1px">#' + esc(d.no) + '</div>' +
    '</div></div>' +
    '<div style="display:flex;gap:16px;margin-top:4mm;font-size:11px;color:#aaa;border-top:1px solid rgba(255,255,255,0.1);padding-top:3mm">' +
    ...
    '<div style="font-size:11px;font-weight:700;text-transform:uppercase;letter-spacing:.5px;color:#999">Received From</div>' +
    ...
    '<div style="font-size:11px;color:#888;text-transform:uppercase;letter-spacing:.5px;margin-bottom:2px">Amount</div>' +
    ...
    '<tr><td style="padding:3mm 0;border-bottom:1px solid #eee;font-size:12px;font-weight:700;color:#999;text-transform:uppercase;width:25%">Payment</td>' +
    '<td style="padding:3mm 0;border-bottom:1px solid #eee;font-size:14px;color:#222">' + esc(d.pm) + d.chqHtml + '</td></tr>' +
    ((d.bk||d.td) ? '<tr><td style="padding:3mm 0;border-bottom:1px solid #eee;font-size:12px;font-weight:700;color:#999;text-transform:uppercase">Bank / Date</td>' +
    '<td style="padding:3mm 0;border-bottom:1px solid #eee;font-size:14px;color:#222">' + esc(d.bk) + (d.bk&&d.td?' / ':'') + esc(d.td) + '</td></tr>' : '') +
    '<tr><td style="padding:3mm 0;border-bottom:1px solid #eee;font-size:12px;font-weight:700;color:#999;text-transform:uppercase">Purpose</td>' +
    ...
    '<div style="font-size:10px;color:#888">Receiver</div>' +
    (c.signature ? '<div style="margin-top:5px"><img src="' + esc(c.signature) + '" style="max-width:80px;max-height:30px;object-fit:contain"><div style="font-size:10px;color:#888">Authorized Signature</div></div>' : '') +
    '</div></div>' : '') +
    '</div>' +
    '<div style="margin-top:4mm;background:#1a1a2e;padding:2.5mm 14mm;display:flex;justify-content:space-between;font-size:10px;color:#888">' +
    '<div>' + esc(c.name) + '</div>' +
