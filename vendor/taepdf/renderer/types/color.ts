...
export type Gradient =
  | { type: 'linear'; angle: number; corner?: string; repeating?: boolean; stops: GradientStop[] }
  ...
  | { type: 'radial'; cx?: number; cy?: number; fx?: number; fy?: number; radius?: number; repeating?: boolean; stops: GradientStop[] }
