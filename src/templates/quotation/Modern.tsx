...
<html><head><meta charset="utf-8"><style>
  ...
  * { box-sizing:border-box;margin:0;padding:0; }
  ...
  .notes { margin-top:16px; padding:12px 16px; background:#f8fafc; border-radius:8px; border-left:3px solid ${p}; font-size:10px; color:#4b5563; }
  .terms { margin-top:8px; padding:12px 16px; background:#f8fafc; border-radius:8px; border-left:3px solid #94a3b8; font-size:10px; color:#4b5563; }
  .sig { display:flex; justify-content:flex-end; align-items:center; gap:24px; margin-top:20px; }
...
<div class="info-grid">
  ...
  <div class="card" style="text-align:right;">
    ...
    <div class="card-label" style="margin-top:4px;">Valid Until</div>
