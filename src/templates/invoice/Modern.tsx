    ...
    <div style="position:relative;min-height:100vh;background:#fff;font-family:'Inter',Arial,Helvetica,sans-serif;font-size:14px;line-height:1.5;color:#374151">
      ...
      <div style="padding:14mm 20mm 10mm 26mm">
        ...
        <table style="width:100%;border-collapse:separate;border-spacing:0;margin-top:8mm;font-size:14px;border:1px solid #f1f5f9;border-radius:10px;overflow:hidden">
          ...
          <tbody>${itemsRows || '<tr><td colspan="5" style="padding:40px;text-align:center;color:#64748b">No items</td></tr>'}</tbody>
        </table>
        <div style="background:#f8fafc;border:1px solid #f1f5f9;border-radius:10px;padding:20px 24px;margin-top:8mm;max-width:320px;margin-left:auto">
          <div style="display:flex;justify-content:space-between;padding:6px 0;font-size:14px"><span style="color:#6b7280">Subtotal</span><span style="font-weight:500;color:#1f2937">${d.cur.symbol}${d.sv}</span></div>
      ...
      ${c.invFooter ? `<div style="text-align:center;font-size:12px;color:#64748b;padding:3mm 0">${esc(c.invFooter)}</div>` : ''}
    </div>
  `)
}
