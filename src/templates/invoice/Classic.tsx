    ...
    <div style="font-family:Arial,Helvetica,sans-serif;font-size:20px;color:#2d2d2d;position:relative;background:#fff;min-height:100vh;padding:0">
      ...
      <div style="padding:6mm 16mm">
        <div style="display:flex;justify-content:space-between;align-items:center">
          <div>
            <div style="font-size:20px;font-weight:700;color:${pc}">TAX INVOICE</div>
            ${showAr ? '<div dir="rtl" unicode-bidi="embed" style="font-size:20px;color:#999">\u0641\u0627\u062A\u0648\u0631\u0629 \u0636\u0631\u064A\u0628\u064A\u0629</div>' : ''}
          </div>
      ...
      <div style="padding:6mm 16mm">
        <div style="font-size:15px;text-transform:uppercase;letter-spacing:1px;color:#999;margin-bottom:4px">Bill To${showAr ? ' / \u0625\u0644\u0649 \u0627\u0644\u0633\u064A\u062F' : ''}</div>
      ...
      <div style="padding:6mm 16mm;display:flex;justify-content:flex-end">
        <div style="min-width:240px;text-align:right">
          ...
          <div style="display:flex;justify-content:space-between;padding:4px 0;font-size:20px;font-weight:700"><span>Total Due:</span><span>${d.cur.symbol}${d.gv}</span></div>
          <div style="font-size:15px;color:#666;font-style:italic;padding-top:4px">${esc(d.gw)}</div>
        </div>
      </div>
      <div style="padding:0 16mm">
        ${d.pd ? `<div style="font-size:20px;margin-bottom:4px"><strong>Payment:</strong> ${esc(d.pd)}</div>` : ''}
      ...
      <div style="padding:6mm 16mm;display:flex;gap:20px;align-items:flex-end">
        ...
        ${c.signature ? `<div><img src="${esc(c.signature)}" style="max-width:100px;max-height:50px;object-fit:contain" /><div style="font-size:15px;color:#666;border-top:1px solid #999;padding-top:2px;margin-top:2px">Authorized Signature${showAr ? ' / \u0627\u0644\u062A\u0648\u0642\u064A\u0639' : ''}</div></div>` : ''}
      </div>
