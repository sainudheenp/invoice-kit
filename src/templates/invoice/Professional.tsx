...
export function InvoiceProfessional(d: InvTemplateData): string {
  ...
  const rows = d.items.map((item, i) => {
    ...
    <tr>
      ...
      <td style="padding:4px 6px;border:1px solid #cbd5e1;font-size:9px;text-align:right;">${taxDisplay}</td>
...
<html><head><meta charset="utf-8"><style>
  ...
  * { box-sizing:border-box;margin:0;padding:0; }
  ...
  .info-grid { display:flex; gap:0; border:1px solid #cbd5e1; margin-bottom:16px; }
  ...
  .footer { margin-top:16px; padding-top:8px; border-top:1px solid #cbd5e1; font-size:7px; color:#64748b; text-align:center; text-transform:uppercase; letter-spacing:0.3px; }
</style></head><body>
