            ...
            <div key={idx} className="flex items-center gap-2.5 p-3 rounded-xl bg-[var(--color-input-bg)] border border-[var(--color-input-border)]">
              ...
              <input
                ...
                onChange={(e) => updateItem(idx, 'qty', e.target.value)}
                  className="w-16 px-2 py-2 rounded-lg border border-[var(--color-input-border)] bg-[var(--color-input-bg)] text-sm text-right outline-none focus:ring-2 focus:ring-[var(--color-primary-ring)]"
                placeholder="Qty"
              />
              <input
                type="number"
                ...
                className="w-24 px-2 py-2 rounded-lg border border-[var(--color-input-border)] bg-[var(--color-input-bg)] text-sm text-right outline-none focus:ring-2 focus:ring-[var(--color-primary-ring)]"
                placeholder="Price"
              />
